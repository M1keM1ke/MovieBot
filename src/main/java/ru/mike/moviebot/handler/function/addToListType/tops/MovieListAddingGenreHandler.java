...
@Component
public class MovieListAddingGenreHandler
    ...
    public String getMessage(Update update, String userMessage) {
        ...
        if (list.isPresent() && (userByChatId.getUserState() == BotState.CURRENT_GENRE_TOP ||
                userByChatId.getUserState() == BotState.CONTINUE_GENRE)) {
