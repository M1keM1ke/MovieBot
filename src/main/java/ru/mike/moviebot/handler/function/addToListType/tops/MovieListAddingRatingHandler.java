...
@Component
public class MovieListAddingRatingHandler
    ...
    public String getMessage(Update update, String userMessage) {
        ...
        if (list.isPresent() && (userByChatId.getUserState() == BotState.RATING_TOP ||
        userByChatId.getUserState() == BotState.CONTINUE_RATING)) {
